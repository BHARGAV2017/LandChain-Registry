...
export default function Verify() {
  ...
  const canTransfer = !!(connectedWallet && verifiedOwnerWallet && connectedWallet === verifiedOwnerWallet);
  const ownersMatch =
  ...
  return (
    <div>
      <div className="card">
        ...
        <p className="meta">
          Anyone can verify a parcel (no wallet). Only the verified owner can transfer.
          Try seeded IDs: <code>LP-DEMO-001</code>, <code>LP-DEMO-002</code>.
        </p>
        ...
        <>
          <div className="card certificate">
            <div className="certificate-header">
              ...
              <div className={`certificate-badge ${ownersMatch ? "ok" : "warn"}`}>
                {data.onChain?.owner ? "Verified on blockchain" : "Record found"}
              </div>
            </div>
